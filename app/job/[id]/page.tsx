      ...
      {jobs.length > 0 ? (
        ...
        <div className="max-w-5xl w-full bg-white shadow-lg rounded-lg overflow-hidden">
          <div className="relative">
            ...
            <div className="flex items-center p-8 bg-gradient-to-r from-[#ED1148] to-red-800">
              <img
            ...
            <div className="p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-2">
                  <div className="bg-gray-50 p-4 rounded-lg shadow-sm flex items-center">
                    <FaMapMarkerAlt className="text-[#ED1D48] mr-3" size={24} />
                    <div>
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg shadow-sm flex items-center">
                    <FaCalendarAlt className="text-[#ED1D48] mr-3" size={24} />
                    <div>
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg shadow-sm flex items-center">
                    <FaBuilding className="text-[#ED1D48] mr-3" size={24} />
                    <div>
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg shadow-sm flex items-center">
                    {jobs[0].isOpen ? (
                      <FaCheckCircle className="text-[#ED1D48] mr-3" size={24} />
                    ) : (
