  ...
  return (
    <div className='flex justify-between w-[1160px]'>
      ...
      <form onSubmit={handleQuery} className='flex gap-2 p-1'>
        ...
        <Button type="submit" className='bg-[#E11D48]'>Search</Button>
      </form>
        <div className='flex m-3 flex-wrap flex-col gap-2 p-3   '>
           {jobs.map((job) => (
            <JobCard job={job}/>
          ))} 
        </div>
        ...
        <h1 className='font-semibold'>Women entrepreneurs of the day</h1>
        <ExpandableCardDemo/>
        </div>
    </div>
  )
