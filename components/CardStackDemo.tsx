...
const CARDS = [
  {
    ...
    content: (
      <p>
        HerCircle has streamlined our hiring process at Acme Corp. Its easy-to-use
  ...
  },
  {
    ...
    content: (
      <p>
        I landed my dream job quickly with <Highlight>HerCircle</Highlight>. The
  ...
  },
  {
    ...
    content: (
      <p>
        <Highlight>HerCircle</Highlight> has been a huge asset for Future Enterprises.
  ...
  },
  {
    ...
    content: (
      <p>
        <Highlight>HerCircle</Highlight> has greatly helped us at Creative Solutions.
  ...
  },
  {
    ...
    content: (
      <p>
        <Highlight>HerCircle</Highlight> made my job search effortless. I found
